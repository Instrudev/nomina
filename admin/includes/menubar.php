<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="./cuentas_cobro.php" ><i class="fa fa-google-wallet"></i> <span>facturas</span></a></li>
      <li><a href="./estadistica.php" ><i class="fa fa-bandcamp"></i> <span>Estadistica</span></a></li>
