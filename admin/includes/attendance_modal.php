			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="attendance_edit.php">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="date">
								<input type="text" class="form-control" id="datepicker_edit" name="edit_date" readonly>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="bootstrap-timepicker">
								<input type="time"  id="edit_time_in" name="edit_time_in" >
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="bootstrap-timepicker">
								<input type="time"  id="edit_time_out" name="edit_time_out">
							</div>
						</div>
					</div>
					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Festivo</label>
						<div class="col-sm-9">
						<select name="festivo" required>
							<option value="" selected disabled hidden>Dia Festivo?</option>
							<option value="dom">Si</option>
							<option value="sab">No</option>
				...
				<div class="form-group">
					...
					<select name="entry" required>
							<option value="" selected disabled hidden>Entradas</option>
							<option value="1">1</option>
							<option value="2">2</option>
							
						</select>
						-->
						<label for="" class="col-sm-3 control-label">Entrada</label>
						<div class="col-sm-9">
						<input type="number" id="entradas" name="entry" readonly>
