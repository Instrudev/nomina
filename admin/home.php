...
$expiry_date = '2024-06-30'; // Reemplaza con la fecha real de vencimiento
$diff = date_diff(date_create($today), date_create($expiry_date));
$days_left = $diff->format("%r%a"); // Días restantes para el vencimiento
