<?php
	...
	if(isset($_POST['add'])){
		...
		if($query->num_rows < 1){
			...
			if($query->num_rows > 0 && $data["entradas"] == '1'){
				...
				//
				$sql = "INSERT INTO attendance (employee_id, date, time_in, time_out, status, entradas, salidas) VALUES ('$emp', '$date', '$time_in', '$time_out', '$logstatus', 2,2)";
				
				if($conn->query($sql)){
					$_SESSION['success'] = 'REGISTRO 2 ENTRADA EXITOSO';
					$id = $conn->insert_id;
