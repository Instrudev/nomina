...
$horas_trab = 50.64;
$precio_hor =          round($salario_base / 240, 0);
$dia_ord =             round(($salario_base / 240) * 8, 0);
...
$entrada = new DateTime("20:00:13");
$salida = new DateTime("22:00:58");
...
$resumen = [
    ...
    'Nocturnas' =>$precios['precio_hor_noc'] * $nocturnas,
